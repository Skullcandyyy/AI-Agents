...
docs=[
    Document(page_content="Python is widely used in Artificial Intelligence and Machine Learning.", metadata={"source": "doc1"}),
    Document(page_content="Pandas is used for Data Analysis in Python.", metadata={"source": "doc2"}),
    Document(page_content="Neural networks are used in deep learning.", metadata={"source": "doc3"})
]
